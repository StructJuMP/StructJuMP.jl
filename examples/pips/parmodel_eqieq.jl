...
for i in 1:scen
    ...
    @addNLConstraint(bl,        19.1*x[1]             - 19.2*x[3]               - 19.3*y1[1] + 19.4*y1[2]                == 209)
    @addNLConstraint(bl,                    18.1*x[2] + 18.2*x[3]                                         - 18.3*y1[3]   == 208)
    @addNLConstraint(bl,                                17.1*x[3] + 17.2*x[4]                + 17.4*y1[2]                == 207)
